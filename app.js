...
const ChatView = {
    ...
    template: `
        <div class="chat-wrapper" style="display: flex; flex-direction: column; height: 100%; padding-top: calc(10px + env(safe-area-inset-top, 10px)); padding-bottom: calc(85px + env(safe-area-inset-bottom, 0px));">
            ...
            <div class="twitch-chat-list" id="twitch-chat-list" @click="closePicker" style="flex: 1; overflow-y: auto; overscroll-behavior-y: contain; -webkit-overflow-scrolling: touch; padding: 10px 12px; padding-bottom: 20px;">
            ...
            <div class="chat-emote-tray" v-show="showPicker && isLoggedIn" @click.stop style="position: absolute; bottom: calc(65px + 85px + env(safe-area-inset-bottom, 0px)); z-index: 70; width: 100%;">
            ...
            <div class="custom-chat-input-area" style="position: relative; bottom: 0; z-index: 60; flex-shrink: 0; padding-bottom: 15px;">
...
const MoreView = {
    template: `
        <div class="more-container" style="display: flex; flex-direction: column; height: 100%; padding: calc(10px + env(safe-area-inset-top, 10px)) 16px calc(85px + env(safe-area-inset-bottom, 0px)); gap: 8px;">
            ...
            <a href="https://www.youtube.com/@CodeMiko" target="_blank" class="social-card" style="flex: 1; padding: 0 16px; border-radius: 12px; min-height: 40px;">
            ...
            <a href="https://kick.com/codemiko" target="_blank" class="social-card" style="flex: 1; padding: 0 16px; border-radius: 12px; min-height: 40px;">
            ...
            <a href="https://discord.com/invite/codemiko" target="_blank" class="social-card" style="flex: 1; padding: 0 16px; border-radius: 12px; min-height: 40px;">
            ...
            <a href="https://app.fanfix.io/@codeyuna" target="_blank" class="social-card" style="flex: 1; padding: 0 16px; border-radius: 12px; min-height: 40px;">
            ...
            <a href="https://www.tiktok.com/@codemiko" target="_blank" class="social-card" style="flex: 1; padding: 0 16px; border-radius: 12px; min-height: 40px;">
            ...
            <a href="https://twitter.com/codemiko" target="_blank" class="social-card" style="flex: 1; padding: 0 16px; border-radius: 12px; min-height: 40px;">
            ...
            <a href="https://www.instagram.com/thecodemiko/" target="_blank" class="social-card" style="flex: 1; padding: 0 16px; border-radius: 12px; min-height: 40px;">
            ...
            <a href="https://www.snapchat.com/add/codemiko" target="_blank" class="social-card" style="flex: 1; padding: 0 16px; border-radius: 12px; min-height: 40px;">
            ...
            <a href="https://www.facebook.com/codemikoofficial" target="_blank" class="social-card" style="flex: 1; padding: 0 16px; border-radius: 12px; min-height: 40px;">
...
const GeraldMinigames = {
    ...
    data() {
        return {
            gameDeck: [
                ...
                { id: 'pineapple', label: '🚪 Pineapple Walk', prompt: 'External visual disruption detected. Chris has walked in unannounced. Mock the technician\'s complete loss of streaming privacy.' },
    ...
    template: `
        <div class="chat-emote-tray" v-show="showMinigames" style="position: absolute; bottom: 100%; border-bottom:none; border-radius:16px 16px 0 0; background: var(--bg-color); width: 100%;">
            <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 6px; padding: 12px; width: 100%;">
                <button v-for="g in gameDeck" :key="g.id" class="bribe-btn" style="padding: 6px 2px; border-radius: 12px; background: var(--card-bg); border: 1px solid var(--border-color); color: var(--text-main); font-weight: bold; text-align: center; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px;" @click.stop="$emit('play-game', g)">
                    <span style="font-size: 16px;">{{ g.label.split(' ')[0] }}</span>
                    <span style="font-size: 10px; line-height: 1.1;">{{ g.label.substring(g.label.indexOf(' ') + 1) }}</span>
                </button>
            </div>
        </div>
    `
...
const GeraldView = {
    ...
    template: `
        <div class="gerald-container" style="flex: 1; display: flex; flex-direction: column; height: 100%; padding-top: calc(10px + env(safe-area-inset-top, 10px)); padding-bottom: calc(85px + env(safe-area-inset-bottom, 0px)); overflow: hidden;">
            ...
            <div class="gerald-messages" id="gerald-msgs" @click="$emit('close-pickers')" style="flex: 1; overflow-y: auto; overscroll-behavior-y: contain; -webkit-overflow-scrolling: touch; padding: 10px 16px; padding-bottom: 20px;">
            ...
            <div class="gerald-action-area" style="position: relative; bottom: 0; z-index: 50; flex-shrink: 0; padding-bottom: 10px;">
...
createApp({
    ...
    setup() {
        ...
        onMounted(async () => {
            ...
            setTimeout(() => { splashVisible.value = false; }, 100); 
        });
