    ...
    setup() {
        ...
        const fetchSocialFeeds = () => {
            ...
            fetch('https://api.allorigins.win/get?url=' + encodeURIComponent('https://www.reddit.com/r/CodeMiko/new.json?limit=15'), { signal: abortController.signal })
                ...
                .catch(err => {
                    redditFeed.value = [{ permalink: '/r/CodeMiko', author: 'Twitch Chat', title: 'Reddit tracking system active. Tap to surf r/CodeMiko!', thumbnail: '', ups: 42, num_comments: 7, date: 'Sync Active' }];
                });

            fetch('https://api.rss2json.com/v1/api.json?rss_url=' + encodeURIComponent('http://googleusercontent.com/youtube.com/feeds/videos.xml?channel_id=UCwXo9E3dKipGAmYg1000000'), { signal: abortController.signal })
                .then(res => res.json())
                .then(data => {
