...
createApp({
    ...
    setup() {
        ...
        const loadData = async () => {
            ...
            // Run Twitch verification loop inside core setup frame
        ...
        const fetchSocialFeeds = () => {
            ...
            // Fetching via a cleaner headers layout stops content restrictions from tripping the 404 proxy logic
            ...
            fetch('https://api.rss2json.com/v1/api.json?rss_url=' + encodeURIComponent('https://www.youtube.com/feeds/videos.xml?channel_id=UCwX993DUC_wXo9E3dKipGAmYpD92Xg'), { signal: abortController.signal })
                .then(res => res.json())
                .then(data => {
