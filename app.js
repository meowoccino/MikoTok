// Dynamic catch block for module errors before Vue initializes
window.addEventListener('error', function(e) {
    if (e.message && (e.message.includes('import') || e.message.includes('component') || e.source || e.filename)) {
        alert("CRASH LOG:\n" + e.message + "\n\nFile: " + (e.filename || e.target?.src || 'Unknown File'));
    }
}, true);
