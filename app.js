...
const ChatView = {
    ...
    template: `
        <div class="chat-wrapper" style="flex: 1; display: flex; flex-direction: column; overflow: hidden; padding-bottom: calc(85px + env(safe-area-inset-bottom, 0px));">
            ...
            <!-- Native scrolling added here -->
            <div class="twitch-chat-list" id="twitch-chat-list" @click="closePicker" style="flex: 1; overflow-y: auto; padding: 10px 12px; overscroll-behavior-y: contain; -webkit-overflow-scrolling: touch;">
...
const MoreView = {
    template: `
        <!-- Native scrolling added here -->
        <div class="more-container" style="flex: 1; overflow-y: auto; overscroll-behavior-y: contain; -webkit-overflow-scrolling: touch; padding: 12px 16px; padding-bottom: calc(85px + env(safe-area-inset-bottom, 0px));">
            
            <a href="https://throne.com/codemiko" target="_blank" style="background: #0ea5e9; color: #fff; border-radius: 12px; padding: 12px 16px; display: flex; align-items: center; justify-content: space-between; text-decoration: none; font-weight: bold; margin-bottom: 8px; font-size: 15px;">
                <span>Throne</span> 
            ...
            <!-- The Goldilocks Zone: 12px 14px padding, 20px icons, 14px text. Fits all 12 links exactly without scrolling -->
            <div style="display:flex; flex-direction:column; gap:6px;">
                <a href="https://www.twitch.tv/codemiko" target="_blank" class="social-card" style="padding: 12px 14px; border-radius: 12px;">
                    <svg viewBox="0 0 24 24" class="social-icon" style="width: 20px; height: 20px; color: #9146FF;"><path fill="currentColor" d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z"/></svg>
                    <span style="color: var(--text-main); font-size: 14px;">Twitch</span>
                </a>
                
                <a href="https://www.youtube.com/@CodeMiko" target="_blank" class="social-card" style="padding: 12px 14px; border-radius: 12px;">
                    <svg viewBox="0 0 24 24" class="social-icon" style="width: 20px; height: 20px; color: #FF0000;"><path fill="currentColor" d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    <span style="color: var(--text-main); font-size: 14px;">YouTube</span>
                </a>
                
                <a href="https://kick.com/codemiko" target="_blank" class="social-card" style="padding: 12px 14px; border-radius: 12px;">
                    <svg viewBox="0 0 24 24" class="social-icon" style="width: 20px; height: 20px; color: #53FC18;"><path fill="currentColor" d="M19 2H5a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V5a3 3 0 0 0-3-3zM10.1 14.5v3.3H7.4V6.2h2.7v4.6l3.3-4.6h3.4l-3.9 5.1 4.2 6.5h-3.5z"/></svg>
                    <span style="color: var(--text-main); font-size: 14px;">Kick</span>
                </a>
                
                <a href="https://discord.com/invite/codemiko" target="_blank" class="social-card" style="padding: 12px 14px; border-radius: 12px;">
                    <svg viewBox="0 0 24 24" class="social-icon" style="width: 20px; height: 20px; color: #5865F2;"><path fill="currentColor" d="M20.317 4.3698a19.7913 19.7913 0 00-4.8851-1.5152.0741.0741 0 00-.0785.0371c-.211.3753-.4447.8648-.6083 1.2495-1.8447-.2762-3.68-.2762-5.4868 0-.1636-.3933-.4058-.8742-.6177-1.2495a.077.077 0 00-.0785-.037 19.7363 19.7363 0 00-4.8852 1.515.0699.0699 0 00-.0321.0277C.5334 9.0458-.319 13.5799.0992 18.0578a.0824.0824 0 00.0312.0561c2.0528 1.5076 4.0413 2.4228 5.9929 3.0294a.0777.0777 0 00.0842-.0276c.4616-.6304.8731-1.2952 1.226-1.9942a.076.076 0 00-.0416-.1057c-.6528-.2476-1.2743-.5495-1.8722-.8923a.077.077 0 01-.0076-.1277c.1258-.0943.2517-.1923.3718-.2914a.0743.0743 0 01.0776-.0105c3.9278 1.7933 8.18 1.7933 12.0614 0a.0739.0739 0 01.0785.0095c.1202.099.246.1981.3728.2924a.077.077 0 01-.0066.1276 12.2986 12.2986 0 01-1.873.8914.0766.0766 0 00-.0407.1067c.3604.698.7719 1.3628 1.225 1.9932a.076.076 0 00.0842.0286c1.961-.6067 3.9495-1.5219 6.0023-3.0294a.077.077 0 00.0313-.0552c.5004-5.177-.8382-9.6739-3.5485-13.6604a.061.061 0 00-.0312-.0286zM8.02 15.3312c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9555-2.4189 2.157-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.9555 2.4189-2.1569 2.4189zm7.9748 0c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9554-2.4189 2.1569-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.946 2.4189-2.1568 2.4189Z"/></svg>
                    <span style="color: var(--text-main); font-size: 14px;">Discord</span>
                </a>

                <a href="https://app.fanfix.io/@codeyuna" target="_blank" class="social-card" style="padding: 12px 14px; border-radius: 12px;">
                    <svg viewBox="0 0 24 24" class="social-icon" style="width: 20px; height: 20px;">
                        <defs>
...
const GeraldMinigames = {
    ...
    template: `
        <div class="chat-emote-tray" v-show="showMinigames" style="position: absolute; bottom: 100%; border-bottom:none; border-radius:16px 16px 0 0; background: var(--bg-color); width: 100%;">
            <!-- Strict 3x3 Grid Layout. Icon separated from text for a clean look -->
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; padding: 12px; width: 100%;">
                <button v-for="g in gameDeck" :key="g.id" class="bribe-btn" style="padding: 10px 4px; font-size: 11px; border-radius: 12px; white-space: normal; line-height: 1.3; background: var(--card-bg); border: 1px solid var(--border-color); color: var(--text-main); font-weight: bold; text-align: center; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px;" @click.stop="$emit('play-game', g)">
                    <span style="font-size: 16px;">{{ g.label.split(' ')[0] }}</span>
                    <span>{{ g.label.substring(g.label.indexOf(' ') + 1) }}</span>
                </button>
            </div>
        </div>
    `
...
const GeraldView = {
    ...
    template: `
        <div class="gerald-container" style="flex: 1; display: flex; flex-direction: column; overflow: hidden; padding-bottom: calc(85px + env(safe-area-inset-bottom, 0px));">
            ...
            <!-- Added smooth native overscroll -->
            <div class="gerald-messages" id="gerald-msgs" @click="$emit('close-pickers')" style="flex: 1; overflow-y: auto; overscroll-behavior-y: contain; -webkit-overflow-scrolling: touch; padding: 10px 16px;">
...
createApp({
    ...
    setup() {
        ...
        const updateThemeClass = () => {
            ...
            // Absolutely fixes the native Android scrolling glitch in dark mode
        ...
        const parseIrcMessage = (raw) => {
            ...
            // PERMANENT BADGE MEMORY: Saves your badges locally the second it sees you talk!
            if (twitchUsername.value && user.toLowerCase() === twitchUsername.value.toLowerCase() && badges.length > 0) {
                localStorage.setItem('my_twitch_badges', JSON.stringify(badges));
            }
        ...
        const sendTwitchChatMessage = (msg) => {
            ...
            // Grabs the permanent badge memory we secretly saved when you talked earlier!
            let myBadges = [];
            try {
            ...
            // FORCED DATABASE SAVE: Locks your message into history so it survives refresh!
            sbClient.from('twitch_chat_logs').insert({
                username: twitchUsername.value || 'You',
                message: msg,
                color: '#9146FF',
        ...
        const disconnectTwitch = () => {
            ...
            localStorage.removeItem('my_twitch_badges');
        ...
        onMounted(async () => {
            ...
            // INSTANT SPLASH FADE FOR FASTER NATIVE FEEL
        ...
        return {
            ...
            handleLogin: async () => { 
                try {
                    ...
                    if (error) {
                        toast.value = { visible: true, message: `Login Failed: ${error.message}` };
                    ...
                    if (data.user) { 
                        ...
                        // FORCED STATE SWITCH AND DATA RELOAD (NO TOAST)
                        const { data: hist } = await sbClient.from('gerald_history').select('*').eq('user_id', currentUser.value.id).order('created_at', { ascending: true });
                        if (hist && hist.length > 0) { 
                            geraldMessages.value = hist.map(r => ({ role: r.role, content: r.content })); 
                        }
                    ...
                    toast.value = { visible: true, message: `System Error: ${err.message}` };
                    setTimeout(() => toast.value.visible = false, 3000);
                }
            },
